...
- Video
![videos](dataset/video_input.png) |
...
| Model | Visualization |
|:---|:---|
| YOLOv8n | ![YOLOv8n](result/output_v8.png) |
| YOLOv11n | ![YOLOv11n](result/output_v11.png) |
| YOLOv26n | ![YOLOv26n](result/output_v26.png) |

Video (tested with YOLOv8n only — video comparison across versions is a future step, not yet done):

[Watch YOLOv8n video output](result/video_input.avi)
